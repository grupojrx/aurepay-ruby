...
module AurePay
  class DepositsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [SuccessEnvelope]
    def deposits_get_payload(id, opts = {})
      data, _status_code, _headers = deposits_get_payload_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SuccessEnvelope, Integer, Hash)>] SuccessEnvelope data, response status code and response headers
    def deposits_get_payload_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DepositsApi.deposits_get_payload ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DepositsApi.deposits_get_payload"
      end
      # resource path
      local_var_path = '/deposits/{id}/payload'.sub('{id}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DepositsApi.deposits_get_payload",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DepositsApi#deposits_get_payload\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
