...
module AurePay
  class WalletsApi
    ...
    # @param id [String] Identificador ULID do recurso
    # @param [Hash] opts the optional parameters
    # @option opts [WalletsVerificationResendRequest] :wallets_verification_resend_request 
    # @return [SuccessEnvelope]
    def wallets_verification_resend(id, opts = {})
      data, _status_code, _headers = wallets_verification_resend_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [WalletsVerificationResendRequest] :wallets_verification_resend_request 
    # @return [Array<(SuccessEnvelope, Integer, Hash)>] SuccessEnvelope data, response status code and response headers
    def wallets_verification_resend_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WalletsApi.wallets_verification_resend ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling WalletsApi.wallets_verification_resend"
      end
      # resource path
      local_var_path = '/wallets/{id}/verification/resend'.sub('{id}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'wallets_verification_resend_request'])
      ...
      new_options = opts.merge(
        :operation => :"WalletsApi.wallets_verification_resend",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WalletsApi#wallets_verification_resend\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
